...
## Trong pygame: Ox: từ trái => phải. Oy: từ trên => dưới

## Lớp Snake đại diện cho con rắn
class Snake:
    def __init__(self):
        ## Khởi tạo các thuộc tính cho rắn
        self.size = 10
        self.body = [[100, 50], [90, 50], [80, 50]]  ## Vị trí ban đầu của rắn x,y
    ...
    def move(self):
        ...
        ### Xóa phần cuối của rắn nếu nó không ăn thức ăn
        self.body.pop()
